...
import "./CarrouselN.css"; // Asegúrate de crearlo también

export function CarrouselNovedades() {
  const novedades = [
    {
      title:
    ...
    texto: 'Una carta de amor a sus raices latinas a ritmo de salsa, mambo y merengue'
    },
    {
      title: "afroLOVA 25'",
      autor: "Rels B",
    ...
    },
    {
      ...
      image:
        ...
        texto:'Un autorretrato de aire melancolico e influencias transatlanticas'
    },
  ];
    ...
    <div className="carousel-container">
      <Swiper spaceBetween={2} slidesPerView={"auto"} grabCursor={true}>
        {novedades.map((item, index) => (
          <SwiperSlide key={index} className="miSlidePersonalizado" style={{}}>
            <div className="card">
